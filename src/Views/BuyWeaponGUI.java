...
public class BuyWeaponGUI extends JFrame {
    JFrame frame;
    JPanel panel;
    ...
    public BuyWeaponGUI() {
        ...
        weaponStatsArea.setBounds(20, 60, 345, 90);
        weaponStatsArea.setFont(song.deriveFont(Font.BOLD, 20f));
        panel.add(weaponStatsArea);

        confirmLabel = new JLabel();
        confirmLabel.setBounds(20, 160, 345, 30);
